...
public class ExcelXlsxReader extends DefaultHandler {
  ...
  private ArrayList<ArrayList> tempA = new ArrayList<ArrayList>();
  ...
  public String getDataValue(String value, String thisStr) {
    ...
    case SSTINDEX:
      ...
      thisStr = value.toString();
      /*
       * try { int idx = Integer.parseInt(sstIndex); XSSFRichTextString rtss =
       * new XSSFRichTextString(sst.getEntryAt(idx)); thisStr = rtss.toString();
       * rtss = null; } catch (NumberFormatException ex) { thisStr =
       * value.toString(); }
       */
      break;
    case NUMBER:
      if (formatString != null) {
        thisStr = formatter.formatRawCellContents(Double.parseDouble(value),
  ...
  public void endElement(String uri, String localName, String name)
    ...
    if (nextIsString && StringUtils.isNotEmpty(lastContents)
        && StringUtils.isNumeric(lastContents) && !"c".equals(name)) {
      int idx = Integer.parseInt(lastContents);
      lastContents =sst.getEntryAt(idx).toString(); //new XSSFRichTextString(sst.getEntryAt(idx)).toString();
    }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("**********************************************");
      ExcelReaderUtil.readExcel(rowReader,
          "C:\\Users\\wilson82740\\Desktop\\export.xlsx");
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
